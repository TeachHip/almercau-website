<?php include 'includes/header.php'; ?>
            ...
            <div class="space-y-4" x-data="{ openFaq: null }">
                ...
                <div class="rounded-xl overflow-hidden">
                    <button @click="openFaq = openFaq === 1 ? null : 1" class="w-full flex items-center justify-between p-6 bg-white hover:bg-gray-50 transition">
                        <div class="flex items-center gap-4">
                            ...
                            <h3 class="text-2xl font-bold text-gray-900 text-left">¿Cómo hago un pedido?</h3>
                        </div>
                        <svg class="w-6 h-6 text-gray-600 transition-transform duration-300" :class="{ 'rotate-45': openFaq === 1 }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="rounded-xl overflow-hidden">
                    <button @click="openFaq = openFaq === 2 ? null : 2" class="w-full flex items-center justify-between p-6 bg-white hover:bg-gray-50 transition">
                        <div class="flex items-center gap-4">
                            <span class="text-4xl">❓</span>
                            <h3 class="text-2xl font-bold text-gray-900 text-left">¿Cuándo puedo recoger mi pedido?</h3>
                        </div>
                        <svg class="w-6 h-6 text-gray-600 transition-transform duration-300" :class="{ 'rotate-45': openFaq === 2 }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                        </svg>
                    </button>
                ...
                <div class="rounded-xl overflow-hidden">
                    <button @click="openFaq = openFaq === 3 ? null : 3" class="w-full flex items-center justify-between p-6 bg-white hover:bg-gray-50 transition">
                        <div class="flex items-center gap-4">
                            <span class="text-4xl">❓</span>
                            <h3 class="text-2xl font-bold text-gray-900 text-left">¿Puedo cambiar mi pedido después de hacerlo?</h3>
                        </div>
                        <svg class="w-6 h-6 text-gray-600 transition-transform duration-300" :class="{ 'rotate-45': openFaq === 3 }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                        </svg>
                    </button>
                ...
                <div class="rounded-xl overflow-hidden">
                    <button @click="openFaq = openFaq === 4 ? null : 4" class="w-full flex items-center justify-between p-6 bg-white hover:bg-gray-50 transition">
                        <div class="flex items-center gap-4">
                            <span class="text-4xl">❓</span>
                            <h3 class="text-2xl font-bold text-gray-900 text-left">¿Cómo pago la cuota?</h3>
                        </div>
                        <svg class="w-6 h-6 text-gray-600 transition-transform duration-300" :class="{ 'rotate-45': openFaq === 4 }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                        </svg>
                    </button>
                ...
                <div class="rounded-xl overflow-hidden">
                    <button @click="openFaq = openFaq === 5 ? null : 5" class="w-full flex items-center justify-between p-6 bg-white hover:bg-gray-50 transition">
                        <div class="flex items-center gap-4">
                            <span class="text-4xl">❓</span>
                            <h3 class="text-2xl font-bold text-gray-900 text-left">¿Qué productos están siempre disponibles?</h3>
                        </div>
                        <svg class="w-6 h-6 text-gray-600 transition-transform duration-300" :class="{ 'rotate-45': openFaq === 5 }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                        </svg>
                    </button>
                ...
                <div class="rounded-xl overflow-hidden">
                    <button @click="openFaq = openFaq === 6 ? null : 6" class="w-full flex items-center justify-between p-6 bg-white hover:bg-gray-50 transition">
                        <div class="flex items-center gap-4">
                            <span class="text-4xl">❓</span>
                            <h3 class="text-2xl font-bold text-gray-900 text-left">¿Cómo funcionan los pedidos de frescos?</h3>
                        </div>
                        <svg class="w-6 h-6 text-gray-600 transition-transform duration-300" :class="{ 'rotate-45': openFaq === 6 }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                        </svg>
                    </button>
                ...
                <div class="rounded-xl overflow-hidden">
                    <button @click="openFaq = openFaq === 7 ? null : 7" class="w-full flex items-center justify-between p-6 bg-white hover:bg-gray-50 transition">
                        <div class="flex items-center gap-4">
                            <span class="text-4xl">❓</span>
                            <h3 class="text-2xl font-bold text-gray-900 text-left">¿Puedo traer amigos al bar?</h3>
                        </div>
                        <svg class="w-6 h-6 text-gray-600 transition-transform duration-300" :class="{ 'rotate-45': openFaq === 7 }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                        </svg>
                    </button>
                ...
                <div class="rounded-xl overflow-hidden">
                    <button @click="openFaq = openFaq === 8 ? null : 8" class="w-full flex items-center justify-between p-6 bg-white hover:bg-gray-50 transition">
                        <div class="flex items-center gap-4">
                            <span class="text-4xl">❓</span>
                            <h3 class="text-2xl font-bold text-gray-900 text-left">¿Tengo descuento en eventos?</h3>
                        </div>
                        <svg class="w-6 h-6 text-gray-600 transition-transform duration-300" :class="{ 'rotate-45': openFaq === 8 }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                        </svg>
                    </button>
                ...
                <div class="rounded-xl overflow-hidden">
                    <button @click="openFaq = openFaq === 9 ? null : 9" class="w-full flex items-center justify-between p-6 bg-white hover:bg-gray-50 transition">
                        <div class="flex items-center gap-4">
                            <span class="text-4xl">❓</span>
                            <h3 class="text-2xl font-bold text-gray-900 text-left">¿Puedo dejar de ser mercante?</h3>
                        </div>
                        <svg class="w-6 h-6 text-gray-600 transition-transform duration-300" :class="{ 'rotate-45': openFaq === 9 }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                        </svg>
                    </button>
    ...
    <section class="py-20 bg-white">
        <div class="container mx-auto px-4 max-w-4xl text-center">
            ...
            <a href="https://wa.me/34611183123?text=Hola,%20tengo%20una%20duda%20sobre%20el%20grupo" target="_blank" class="inline-flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white px-10 py-5 rounded-full font-bold text-xl transition transform hover:scale-105 shadow-lg">
