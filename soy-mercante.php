...
<main>
	   <section class="py-4 bg-white">
		   <div class="container mx-auto px-4 max-w-4xl text-center">
			   <h1 class="text-4xl md:text-5xl font-bold text-almercau-blue mb-6 mt-20 md:mt-32">Soy mercante</h1>
	...
	<section id="preguntas-frecuentes" class="py-20 bg-white">
		<div class="container mx-auto px-4 max-w-4xl">
			<h2 class="text-2xl md:text-3xl font-bold text-almercau-blue mb-8 text-center">Preguntas frecuentes - Mercante</h2>
			<?php
