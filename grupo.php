...
<main role="main">
    ...
    <section class="py-20 bg-white">
        <div class="container mx-auto px-4 max-w-6xl">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <!-- Ventaja 1 -->
                <div class="flex flex-col items-center text-center gap-2 md:flex-row md:items-start md:text-left md:gap-4 rounded-xl p-6">
    ...
    <section class="py-20 bg-white">
        <div class="container mx-auto px-4 max-w-4xl text-center">
            ...
            <a href="https://wa.me/34611183123?text=Hola,%20quiero%20informaci%C3%B3n%20sobre%20hacerme%20mercante" target="_blank" class="inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white px-5 md:px-12 py-3 md:py-6 rounded-full font-bold text-2xl transition transform hover:scale-105 shadow-2xl">
