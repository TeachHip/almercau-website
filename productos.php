<?php include 'includes/header.php'; ?>
    ...
    <section class="py-20 bg-almercau-yellow">
        <div class="container mx-auto px-4 max-w-4xl text-center">
            ...
            <a href="https://wa.me/34611183123?text=Hola,%20quiero%20hacerme%20mercante" target="_blank" class="inline-flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white px-10 py-5 rounded-full font-bold text-xl transition transform hover:scale-105 shadow-lg">
