...
?>
    ...
    <!-- Hero Section -->
    <section id="main-content" class="relative h-96 md:h-[500px] flex items-center justify-center" style="background-image: url('assets/imgs/comidas-y-raciones.jpg'); background-size: cover; background-position: center;">
...
<main role="main">
    ...
    <section class="py-20 bg-gray-50">
        <div class="container mx-auto px-2 md:px-4 max-w-6xl">
            ...
            <!-- Bebidas -->
            <div class="mb-12">
                <h2 class="text-3xl md:text-4xl font-bold text-almercau-blue mb-2 md:mb-10 text-center">Para beber</h2>
                <div class="grid md:grid-cols-2 gap-1 md:gap-8 mb-3 md:mb-6">

                    <!-- Bebida 1: Vinos -->
                    <div class="flex flex-col md:flex-row md:items-start md:text-left items-center text-center rounded-xl p-6">
                        <div class="text-5xl mb-2 md:mb-0 md:mr-4">🍷</div>
                        <div>
                    ...
                    <div class="flex flex-col md:flex-row md:items-start md:text-left items-center text-center rounded-xl p-2 md:p-6">
                        <div class="text-5xl mb-2 md:mb-0 md:mr-4">🍺</div>
                        <div>
                ...
                <div class="bg-almercau-yellow bg-opacity-20 border-l-4 border-almercau-yellow rounded-lg p-6 max-w-4xl mx-auto">
                    <div class="flex flex-col md:flex-row md:items-start md:text-left items-center text-center">
                        <div class="text-3xl mb-1 md:mb-0 md:mr-3">🍢</div>
                        <div>
            ...
            <!-- Comidas -->
            <div>
                <h2 class="text-3xl md:text-4xl font-bold text-almercau-blue mb-3 md:mb-12 text-center">Para comer</h2>
        ...
        <div class="container mx-auto px-4 max-w-6xl">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div class="rounded-xl overflow-hidden h-64">
                    <img src="assets/imgs/mesa-sidra-conservas.jpg" alt="Ambiente AlMercáu" class="w-full h-full object-cover hover:scale-105 transition duration-300" loading="lazy">
                </div>
                <div class="rounded-xl overflow-hidden h-64">
                    <img src="assets/imgs/conservas-bonito-1.jpg" alt="Productos AlMercáu" class="w-full h-full object-cover hover:scale-105 transition duration-300" loading="lazy">
                </div>
                <div class="rounded-xl overflow-hidden h-64">
                    <img src="assets/imgs/cotoya-bitter-playa-agua.jpg" alt="Bebidas AlMercáu" class="w-full h-full object-cover hover:scale-105 transition duration-300" loading="lazy">
                </div>
                <div class="rounded-xl overflow-hidden h-64">
                    <img src="assets/imgs/canero-cerveza-cotoya.jpg" alt="Barra AlMercáu" class="w-full h-full object-cover hover:scale-105 transition duration-300" loading="lazy">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-white">
        <div class="container mx-auto px-4 max-w-4xl text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a href="contacto.php#main" class="inline-flex items-center gap-3 bg-almercau-yellow hover:opacity-80 text-gray-900 px-6 py-3 md:px-10 md:py-5 rounded-full font-bold text-xl transition transform hover:scale-105 shadow-lg">
                ...
                <a href="https://wa.me/34611183123?text=Hola,%20quiero%20informaci%C3%B3n%20sobre%20el%20bar" target="_blank" class="inline-flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white px-6 py-3 md:px-10 md:py-5 rounded-full font-bold text-xl transition transform hover:scale-105 shadow-lg">
