...
?>
    ...
    <!-- Hero Section -->
    <section id="main-content" class="relative h-96 flex items-center justify-center" style="background-image: url('assets/imgs/vermut-jamon.jpg'); background-size: cover; background-position: center;">
        <div class="hero-gradient absolute inset-0"></div>
        <div class="relative z-10 text-center text-white px-4" data-aos="fade">
            ...
            <div>
                ...
                <div class="max-w-2xl mx-auto space-y-6">
                    ...
                    <div class="bg-almercau-blue rounded-xl p-8 text-center">
                        ...
                        <div class="flex justify-center gap-6 social-links text-white">
                            <a href="https://www.instagram.com/almercau/" target="_blank" rel="noopener noreferrer" class="w-14 h-14 bg-white bg-opacity-20 hover:bg-opacity-30 rounded-full flex items-center justify-center transition transform hover:scale-110" aria-label="Instagram">
                            ...
                            <a href="https://www.facebook.com/almercau" target="_blank" rel="noopener noreferrer" class="w-14 h-14 bg-white bg-opacity-20 hover:bg-opacity-30 rounded-full flex items-center justify-center transition transform hover:scale-110" aria-label="Facebook">
                                <svg class="w-7 h-7 text-white" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                                </svg>
                            </a>
                            <a href="https://bsky.app/profile/almercau.org" target="_blank" rel="noopener noreferrer" class="w-14 h-14 bg-white bg-opacity-20 hover:bg-opacity-30 rounded-full flex items-center justify-center transition transform hover:scale-110" aria-label="Bluesky">
                                <svg class="w-7 h-7 text-white" fill="currentColor" viewBox="0 0 24 24">
