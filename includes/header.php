...
<head>
    ...
    <meta name="description" content="AlMercáu - Grupo de consumo y degustación en Gijón. Del productor al barrio. Calidad, honestidad, sencillez, vecindad.">
    <title>AlMercáu - Del productor al barrio | Gijón</title>
        ...
        <nav class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="hidden lg:flex items-center space-x-8">
                    ...
                    <a href="#productos" class="text-gray-700 hover:text-almercau-blue transition">Productos</a>
                    <a href="#productores" class="text-gray-700 hover:text-almercau-blue transition">Productores</a>
                    <a href="#eventos" class="text-gray-700 hover:text-almercau-blue transition">Eventos</a>
            ...
            <div x-show="mobileMenuOpen" 
                ...
                <div class="flex flex-col space-y-3">
                    ...
                    <a href="#productos" class="text-gray-700 hover:text-almercau-blue transition py-2">Productos</a>
                    <a href="#productores" class="text-gray-700 hover:text-almercau-blue transition py-2">Productores</a>
                    <a href="#eventos" class="text-gray-700 hover:text-almercau-blue transition py-2">Eventos</a>
