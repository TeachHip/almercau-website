        ...
        <nav class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="hidden lg:flex items-center space-x-8">
                    ...
                    <?php if($current_page == 'productos.php'): ?>
                        <span class="text-almercau-blue font-bold underline">Productos</span>
                    <?php else: ?>
                    ...
                    <?php if($current_page == 'eventos.php'): ?>
                        <span class="text-almercau-blue font-bold underline">Eventos</span>
                    <?php else: ?>
                    ...
                    <?php if($current_page == 'mercantes.php'): ?>
                        <span class="text-almercau-blue font-bold underline">+</span>
                    <?php else: ?>
            ...
            <div x-show="mobileMenuOpen"
                ...
                <div class="flex flex-col space-y-3">
                    ...
                    <?php if($current_page == 'productos.php'): ?>
                        <span class="text-almercau-blue font-bold underline py-2">Productos</span>
                    <?php else: ?>
                    ...
                    <?php if($current_page == 'eventos.php'): ?>
                        <span class="text-almercau-blue font-bold underline py-2">Eventos</span>
                    <?php else: ?>
                    ...
                    <?php if($current_page == 'mercantes.php'): ?>
                        <span class="text-almercau-blue font-bold underline py-2">+</span>
                    <?php else: ?>
